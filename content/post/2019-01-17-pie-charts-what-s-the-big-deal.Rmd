...
1.) When users hit the 'submit' button on the Shiny app, the guess and relative frequencies will be stored. That's it though, no ip address, location data, etc. :)
